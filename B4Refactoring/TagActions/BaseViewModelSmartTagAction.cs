...
namespace Getequ.B4Refactoring.TagActions
{
    ...
    internal class BaseViewModelSmartTagAction : BaseSmartTagAction
    {
        CodeClass2 _controller;

        public BaseViewModelSmartTagAction(ITrackingSpan span, FileCodeModel codeModel, CodeClass2 controller)
            : base(span, codeModel)
        {
        ...
        {
            get { return "Вынести методы BaseViewModel"; }
        }
        ...
        public override void Invoke()
        {
            ...
            form.SetWindowData(stinck, RefactorTarget.BaseViewModel);
