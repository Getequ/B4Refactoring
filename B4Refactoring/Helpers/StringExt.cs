...
namespace Getequ
{
    public static class StringExt
    {
        ...
        public static string CutFirst(this string str, string prefix)
        {
        ...
        public static string CutLast(this string str, string suffix)
        {
        ...
        public static string Ind(this string source, int indent)
        {
            ...
            else
            {
                for (int i = 0; i < indent * -1; i++)
                    if (source.StartsWith(indPart))
                        source = source.Substring(indPart.Length);
            }
            return source;
        }
